...
class LatestGadgetsController extends Controller
{
    public function __invoke()
    {
        $category = Category::where('slug', 'latest-gadgets')->where('status', 'active')->first();
        ...
        return view('frontend.latest-gadgets.index', compact('articles', 'featured', 'tags', 'count'));
    }
}
