    ...
    <div class="bg-vnn-dark text-white text-[11px] py-2 border-b border-vnn-red/30">
        <div class="max-w-7xl mx-auto px-4 flex items-center justify-between">
            ...
            <div class="flex items-center gap-1 sm:gap-2">
                ...
                <button @click="toggleDark()" class="w-8 h-8 p-1.5 sm:w-7 sm:h-7 sm:p-0 flex items-center justify-center text-gray-400 hover:text-vnn-red transition focus:outline-none" aria-label="Toggle dark mode">
