    ...
    <div class="bg-black text-white text-[11px] py-2 border-b border-vnn-red/30">
        <div class="max-w-7xl mx-auto px-4 flex items-center justify-between">
            ...
            <div class="flex items-center gap-1 sm:gap-2">
                ...
                <button @click="toggleDark()" class="w-8 h-8 p-1.5 sm:w-7 sm:h-7 sm:p-0 flex items-center justify-center text-gray-300 hover:text-white transition focus:outline-none" aria-label="Toggle dark mode">
                ...
                <a href="#" class="hidden md:inline text-gray-300 hover:text-white transition ml-1 text-[10px] uppercase font-semibold">e-Paper</a>
            </div>
        </div>
    </div>
    ...
    <header class="bg-black border-b border-gray-800">
        <div class="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
            <div class="flex items-center gap-4">
                <button @click="mobileOpen = !mobileOpen" class="lg:hidden p-2.5 -ml-2 text-gray-300 hover:text-white focus:outline-none" aria-label="Toggle menu">
                ...
                <a href="{{ url('/') }}" class="flex items-center gap-3 shrink-0">
                    ...
                    <span class="font-extrabold text-base sm:text-lg md:text-xl lg:text-2xl tracking-tight font-heading uppercase whitespace-nowrap"><span class="text-vnn-red">VERVE NEWS </span><span class="text-white">NETWORK</span></span>
                    @else
            ...
            <div class="hidden lg:flex items-center gap-3">
                <button @click="searchOpen = !searchOpen; if(!searchOpen) { searchQuery = ''; searchResults = []; }" class="flex items-center gap-2 px-4 py-2 text-sm text-gray-300 border border-gray-700 rounded hover:border-vnn-red hover:text-vnn-red transition" aria-label="Toggle search">
        ...
        {{-- Search Overlay --}}
        <div x-show="searchOpen" x-cloak @click.away="searchOpen = false; searchQuery = ''; searchResults = []" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 -translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" class="border-t border-gray-800 bg-black">
