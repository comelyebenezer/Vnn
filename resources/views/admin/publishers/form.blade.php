<div>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-vnn-blue leading-tight">{{ $editMode ? 'Edit Publisher' : 'Create Publisher' }}</h2>
            <a href="{{ route('admin.publishers.index') }}" class="text-sm text-gray-500 hover:text-vnn-blue transition">← Back to Publishers</a>
        </div>
    </x-slot>
            ...
            <form wire:submit="save" class="space-y-6">
                <div class="bg-white rounded-lg shadow-sm p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <textarea wire:model="signature" rows="3" class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:border-vnn-blue" placeholder="Publisher signature..."></textarea>
