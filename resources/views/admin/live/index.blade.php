<div>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-xl font-extrabold text-gray-900 dark:text-white">Live Videos</h1>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Manage live video streams</p>
            </div>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 p-5 mb-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        <input wire:model.live="search" type="text" placeholder="Search live videos..." class="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-vnn-red focus:ring-1 focus:ring-vnn-red">
                    </div>
                    <div>
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/30">
                                ...
                                <td class="px-5 py-3.5 hidden md:table-cell">
                                    <span class="text-xs text-gray-500">{{ $live->video_type }}</span>
                                </td>
                                <td class="px-5 py-3.5 hidden md:table-cell">
                                    @if($live->is_live)
                                ...
                                <td class="px-5 py-3.5">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <button wire:click="deleteLive({{ $live->id }})" onclick="return confirm('Delete this live video?')" class="text-red-500 hover:text-red-700 text-xs font-semibold">Delete</button>
                                    </div>
                                </td>
                            </tr>
                            @empty
                            <tr>
                                <td colspan="6" class="px-5 py-12 text-center text-gray-400">
                                    <div class="flex flex-col items-center gap-2">
                                        ...
                                        <p>No live videos found.</p>
                                        <a href="{{ route('admin.live.create') }}" class="text-vnn-red hover:underline text-sm font-semibold">Create your first live video</a>
                                    </div>
                                </td>
                            </tr>
                            @endforelse
