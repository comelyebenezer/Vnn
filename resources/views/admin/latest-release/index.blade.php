<div>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-xl font-extrabold text-gray-900 dark:text-white">Latest Release</h1>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Manage latest releases and featured content</p>
            </div>
            <a href="{{ route('admin.latest-release.create') }}" class="flex items-center gap-2 bg-vnn-red text-white text-sm font-bold px-4 py-2.5 rounded-lg hover:bg-vnn-red-dark transition shadow-lg shadow-vnn-red/20">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 p-5 mb-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        <input wire:model.live="search" type="text" placeholder="Search releases..." class="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-vnn-red focus:ring-1 focus:ring-vnn-red">
                    </div>
                    <div>
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/30 transition">
                            <td class="px-5 py-3.5">
                                <div class="flex items-center gap-3">
                                    ...
                                    @endif
                                    <div>
                                        <a href="{{ route('admin.latest-release.edit', $article) }}" wire:navigate class="font-medium text-gray-900 dark:text-gray-100 hover:text-vnn-red transition line-clamp-2">{{ $article->title }}</a>
                            ...
                            <td class="px-5 py-3.5">
                                <div class="flex items-center gap-2">
                                    <a href="{{ route('admin.latest-release.edit', $article) }}" wire:navigate class="inline-flex items-center gap-1 text-vnn-red hover:text-vnn-red-dark text-xs font-semibold bg-red-50 dark:bg-red-900/20 px-2.5 py-1.5 rounded-lg hover:bg-red-100 dark:hover:bg-red-900/40 transition">
                                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                                        Edit
                                    </a>
                                    <button wire:click="deleteArticle({{ $article->id }})" onclick="return confirm('Delete this release?')" class="inline-flex items-center gap-1 text-red-500 hover:text-red-700 text-xs font-semibold bg-red-50 dark:bg-red-900/20 px-2.5 py-1.5 rounded-lg hover:bg-red-100 dark:hover:bg-red-900/40 transition">
                        ...
                        <tr>
                            <td colspan="6" class="px-5 py-16 text-center">
                                ...
                                <p class="text-gray-500 dark:text-gray-400 font-medium">No releases found</p>
