<div>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-vnn-blue leading-tight">Breaking News</h2>
            <a href="{{ route('admin.breaking-news.create') }}" class="bg-vnn-red text-white text-sm font-bold px-4 py-2 rounded hover:bg-vnn-red-dark transition">+ New Breaking News</a>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow-sm p-4 mb-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        <input wire:model.live="search" type="text" placeholder="Search breaking news..." class="w-full border border-gray-300 rounded px-3 py-2 text-sm">
                    </div>
                    <div>
                ...
                <table class="w-full text-sm">
                    <thead class="bg-gray-50 border-b">
                        <tr>
                            ...
                            <th wire:click="sortBy('priority')" class="text-left px-4 py-3 font-semibold text-gray-600 cursor-pointer hover:text-vnn-blue">Priority</th>
                            <th wire:click="sortBy('expires_at')" class="text-left px-4 py-3 font-semibold text-gray-600 cursor-pointer hover:text-vnn-blue hidden md:table-cell">Expires</th>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        @empty
                        <tr>
                            <td colspan="6" class="px-4 py-12 text-center text-gray-400">No breaking news entries found.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
            ...
            <div class="mt-4">{{ $breakingNews->links() }}</div>
        </div>
    </div>
</div>
